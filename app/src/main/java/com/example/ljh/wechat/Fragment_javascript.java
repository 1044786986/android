...
public class Fragment_javascript extends Fragment{
    ...
    class RecyclerViewAdapter_share extends RecyclerView.Adapter<RecyclerViewAdapter_share.ViewHolder> implements View.OnClickListener{
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            RecyclerViewAdapter_share.ViewHolder viewHolder = new RecyclerViewAdapter_share.ViewHolder(view);
            return viewHolder;
        }
