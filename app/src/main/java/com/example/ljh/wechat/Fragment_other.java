...
public class Fragment_other extends Fragment{
    ...
    static Fragment_other fragment_other;
    @Nullable
    @Override
    ...
    class RecyclerViewAdapter_share extends RecyclerView.Adapter<RecyclerViewAdapter_share.ViewHolder> implements View.OnClickListener{
        ...
        @Override
        public RecyclerViewAdapter_share.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(getActivity()).inflate(R.layout.item_share,parent,false);
            ViewHolder viewHolder = new ViewHolder(view);
            return viewHolder;
        }

        public void onBindViewHolder(RecyclerViewAdapter_share.ViewHolder holder, final int position) {
